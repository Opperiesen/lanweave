...
```shell
uv tool install 'lanweave[mcp]==0.7.0'
```
...
```shell
gh release download v0.7.0 --repo Opperiesen/lanweave --dir release-v0.7.0
cd release-v0.7.0
...
gh attestation verify \
  lanweave-0.7.0-py3-none-any.whl \
...
The current v0.7.0 scope is documented in [the roadmap](roadmap-v0.7.0.md),
with [migration-v0.7.md](migration-v0.7.md),
[release-v0.7.0.md](release-v0.7.0.md) and the [VPN evidence](evidence/v0.7.0-vpn.md).
